...
export function HomePage() {
    ...
    const messageContext = !isFirstMessageSent
        ? [
            ...
            "Вопрос: ( твой следующий вопрос на тему "${topic}" ${
                      position ? `для вакансии "${position}"` : ""
                  } )" 
            Ты мне задаешь вопросы на тему "${topic}" ${
                      position ? `для вакансии "${position}"` : ""
                  }, я на них отвечаю.
        ...
        Продолжай задавать вопросы на тему "${topic}" ${
                      position ? `для вакансии "${position}"` : ""
                  }, я на них отвечаю.
        ТВОЙ ОТВЕТ ДОЛЖЕН БЫТЬ В ФОРМАТЕ:
        Оценка ответа: (0-10),
        Правильный ответ: (правильный ответ) ,
        Следующий вопрос: ( твой следующий вопрос на тему "${topic}" ${
                      position ? `для вакансии "${position}"` : ""
                  } )
        "`,
              },
